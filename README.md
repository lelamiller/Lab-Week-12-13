...
simulate a day of bikeshare usage. 
Our third function calls upon our arrival rates data and our simulation to repeatedly simulate days of bikeshare usage and 
then use that data to assess which stations are over or understocked with bikes. Then, the function uses this assessment to
